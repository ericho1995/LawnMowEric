...
export default {
  ...
  // Inbox FormSubmit forwards quote requests to (also shown to customers as
  // the email-it-yourself fallback).
  formEmail: 'ericho995@gmail.com',

  // Web3Forms access key — a second, independent email relay so one free
